...
class NitroGen:
    ...
    def main(self):
        ...
        if os.name == "nt":
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator - Made by Riddler#1425")
        else:
            print(f'\33]0;Nitro Generator - Made by Riddler#1425\a', end='', flush=True)
...
██    ██      ██      ██     ██            ██████████            ██           ██      ██      ██████████
             """)
        time.sleep(2)
        self.slowType("Made by Riddler#1425", .03)
        time.sleep(1)
        self.slowType("\nInput How Many Codes to Generate: ", .03, newLine = False)
        ...
        for i in range(num):
            ...
            if os.name == "nt":
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator - {len(valid)} Valid | {invalid} Invalid - Made by Shifu#1425")
                print("")
            else:
                print(f'\33]0;Nitro Generator - {len(valid)} Valid | {invalid} Invalid - Made by Shifu#1425\a', end='', flush=True)
